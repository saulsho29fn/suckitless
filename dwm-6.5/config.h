...
static const char *eslayout[] = { "setxkbmap", "es", NULL };
static const char *rofimojis[] = { "rofi", "-modi", "emoji", "-show", "emoji", "-kb-custom-1", "Ctrl+c", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_l,      spawn,          {.v = rofibrowser } },
	{ MODKEY,                       XK_v,      spawn,          {.v = uslayout } },
	{ MODKEY,                       XK_n,      spawn,          {.v = eslayout } },
	{ MODKEY|ShiftMask,             XK_h,      spawn,          {.v = roficalc } },
	{ MODKEY,                       XK_y,      spawn,          {.v = rofimojis } },
